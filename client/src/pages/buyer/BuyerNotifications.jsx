...
const BuyerNotifications = () => {
  ...
  const buyerNotifications = filterNotificationsByRole(notifications, PANEL_ROLE);
  const unreadCount = buyerNotifications.filter((n) => !n.isRead).length;
